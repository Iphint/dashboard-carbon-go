  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-lime-50 flex items-center justify-center p-4">
      ...
      <section className="w-full max-w-md bg-white border border-emerald-100 rounded-3xl shadow-xl shadow-emerald-100/60 p-8">
        ...
        <p className="text-sm text-gray-500 mt-1">{t('adminLoginDesc')}</p>

        <form className="mt-7 space-y-4" onSubmit={submit}>
          <label className="block">
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">{t('username')}</span>
          ...
          <label className="block">
            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wide">{t('password')}</span>
            <div className="relative mt-1.5">
